...
namespace PagedList.Mvc
{
	...
	///</summary>
	public class PagedListRenderOptionsSemantic
	{
		///<summary>
		/// The default settings render all navigation links and no descriptive text.
		///</summary>
		public PagedListRenderOptionsSemantic()
		{
			...
			ContainerDivClasses = new[] { "ui pagination menu" };
			UlElementClasses = new[] { "ui pagination menu" };
		...
		///</summary>
		public static PagedListRenderOptions semantic
		{
			get
			{
				return new PagedListRenderOptions
